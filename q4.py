...
for train_index, test_index in kfold.split(reshapedImages):
    ...
    if CLF == 'svm':
        ...
        for index,row in df.iterrows():
            ...
            print('skipping hyperparameter tuning vy giving same values of hyperparamater')
    ...
    if CLF =='tree':
        ...
        for index,row in dfHyperDecision.iterrows():                                                                 
            ...
            print('skipping hyperparameter tuning vy giving same valus of hyperparamater')
            print(foldNum, best_test_Accuracy, best_hyper_params)
            break
    break
